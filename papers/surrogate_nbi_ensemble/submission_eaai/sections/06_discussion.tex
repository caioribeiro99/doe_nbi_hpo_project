...
contrasts that carry our only Holm-significant primary results have \emph{worse} single-objective holdout accuracy at
the knee-selected point, on ROC-AUC and on log-loss alike, and cheaper selected points (supplementary Section~S10)
--- different points of the same trade-off rather than a contradiction of indicator results computed over whole
