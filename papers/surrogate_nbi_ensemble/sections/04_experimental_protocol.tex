...
\texttt{scikit-learn} implementations \citep{pedregosa2011scikit}. The zoo spans the accuracy--cost--calibration space
...
\citep{kerby2014simple} as a distribution-free effect size.
