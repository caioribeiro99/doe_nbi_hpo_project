...
gate, and in $23$--$24/30$ on Porto Seguro and $24/30$ on UCI credit, with hypervolume gains up to $+0.18$. Removing
the surrogate entirely, once anchors are correct, adds much less on three of the four datasets. The first-order fix is also the cheap one: real anchors are the single-objective
...
against none for the surrogate arms, at 3 to 73 times the wall-clock cost, and that spend is strongly conditional: on
UCI credit the threefold premium buys the largest gain, while on Santander a seventy-three-fold premium buys $+0.008$
...
whose sampled core no method under test can influence; and state which cost you are paying. None of these is expensive relative to
